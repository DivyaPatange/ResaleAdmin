...
@section('page_title', 'Education Post')
@section('customcss')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ $singlePost->ad_title }} (&#8377; {{ $singlePost->fees }})</h5>
                </div>
                <?php 
                ...
                <div class="card-body">
                    <div class="row section-padding-50 grid-gallery">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <p><b>Education Stream</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->education_stream }}</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>Counselling Fees</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->fees }}</p>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <p><b>Institute Address</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->institute_address }}</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>Institute Website</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->institute_website }}</p>
                                </div>
                                <div class="col-md-12">
                                    <p><b>Description</b></p>
