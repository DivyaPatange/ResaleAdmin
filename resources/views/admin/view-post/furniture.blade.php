...
@section('title', 'Furnitures Post')
@section('page_title', 'Furnitures Post')
@section('customcss')
                    ...
                    <div class="row section-padding-50 grid-gallery">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <?php 
                                        $typeBrand = DB::table('type_brands')->where('id', $singlePost->type_brand_id)->first();
                                    ?>
                                    <p>: @if(!empty($typeBrand)) {{ $typeBrand->type_brand_name }} @endif</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>Condition</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->condition }}</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>Age</b></p>
                                </div>
