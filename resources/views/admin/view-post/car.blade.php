                    ...
                    <div class="row section-padding-50 grid-gallery">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->fuel_type }}</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>Transmission</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->transmission }}</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>No. of Owners</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->no_of_owners }}</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>Colour</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->colour }}</p>
                                </div>
                                <div class="col-md-3">
                                    <p><b>Insurance</b></p>
                                </div>
                                <div class="col-md-3">
                                    <p>: {{ $singlePost->insurance }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
