                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label for="fname">Role Name<span style="color:red;">*</span></label><span  style="color:red" id="role_err"> </span>
                                    <input type="text" class="form-control @error('role_name') is-invalid @enderror" id="role_name" placeholder="Role Name" name="role_name" >
                                    @error('role_name')
        ...
        <form method="POST" >
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="edit_role_name" id="edit_role_name" class="form-control" value="">
                </div>
                <div class="form-group">
...
<script type=text/javascript>
  var SITEURL = '{{ URL::to('/admin/subCategory/role')}}';
    ...
    function checkSubmit()
    {
        ...
        { 
            ...
            var datastring="role_name="+role_name+"&status="+status+"&id="+id;
            // alert(datastring);
            $.ajax({
                type:"POST",
    ...
    $('body').on('click', '#submitForm', function () {
        ...
        { 
            var datastring="role_name="+role_name+"&status="+status;
            // alert(datastring);
            $.ajax({
                type:"POST",
